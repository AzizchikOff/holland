    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="h-16 lg:h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/order"
                className="relative inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-600 text-white hover:bg-yellow-400 hover:text-red-700 transition-colors text-sm font-semibold"
              >
              ...
              <Link
                to="/order"
                className="hidden sm:inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-600 text-white hover:bg-yellow-400 hover:text-red-700 transition-colors text-sm font-semibold"
              >
              ...
              <button
                ...
                className="lg:hidden inline-flex items-center justify-center w-11 h-11 rounded-xl bg-red-600 text-white hover:bg-yellow-400 hover:text-red-700 transition-colors"
      ...
      >
        <div className="p-4 space-y-2">
          ...
          <Link
            to="/order"
            className="mt-3 flex items-center justify-between gap-3 px-4 py-4 rounded-2xl bg-yellow-400 text-red-800 font-semibold"
          >
            ...
            {totalItems > 0 && (
              <span className="bg-red-700 text-white text-xs font-bold rounded-full px-2 py-1">
                {totalItems} ta
              </span>
            )}
          </Link>
